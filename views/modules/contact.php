<footer class="row" id="contactenos">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="formulario" >
        ...
        <form method="post" onsubmit="return validarMensaje()">
                <input type="text" class="form-control" id="nombreFrontal" name="nombreFrontal"  placeholder="Nombre" required>

                <input type="email" class="form-control" id="emailFrontal" name="emailFrontal" placeholder="Email" required>

                <textarea cols="30" rows="10" id="mensajeFrontal" name="mensajeFrontal" placeholder="Contenido del Mensaje" class="form-control" required></textarea>
            ...
            <?php
                     $mensajes = new SuscribersFrontController();
                     $mensajes->registroMensajes()
