...
function validarMensaje() {
	...
	nombre = $('#nombreFrontal').val()
	mensaje = $('#mensajeFrontal').val()
	...
	if(nombre != "") {
		...
		if(!expresion.test(nombre)){
			...
			$('#nombreFrontal').after('<div class="alert alert-danger">No se permiten números o caracteres especiales</div>'); 
	...
	if(mensaje != "") {
		...
		if (!expresion.test(mensaje)) {
			...
			$('#mensajeFrontal').after('<div class="alert alert-danger">No se permiten caracteres especiales</div>');
